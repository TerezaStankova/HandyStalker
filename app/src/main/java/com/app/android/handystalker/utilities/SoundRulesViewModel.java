...
public class SoundRulesViewModel extends AndroidViewModel {

    // Constant for logging
    private static final String TAG = SoundRulesViewModel.class.getSimpleName();

    private LiveData<List<RuleEntry>> rules;


    public SoundRulesViewModel(Application application) {
        super(application);
        ...
        rules = mRepository.getmSoundRules();
    }
